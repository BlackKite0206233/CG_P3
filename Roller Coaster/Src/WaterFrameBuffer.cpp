...
int WaterFrameBuffer::REFLECTION_WIDTH = 320;
int WaterFrameBuffer::REFLECTION_HEIGHT = 180;
int WaterFrameBuffer::REFRACTION_WIDTH = 1280;
int WaterFrameBuffer::REFRACTION_HEIGHT = 720;
